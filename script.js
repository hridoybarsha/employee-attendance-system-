...
/* ================= PAYROLL (ACCURATE PRESENT-BASED CALCULATION WITH ADVANCE SUM) ================= */
function calculateEmployeePayroll(employee, month) {
    ...
    const netSalary = Math.max(0, Math.round(earnedSalary + bonus - advanceTaken - deduction));

    return {
        employeeId: employee.employeeId,
        month, basicSalary, fullDay, nightShift, halfDay, paidLeave, absent,
        bonus, advance: advanceTaken, deduction, earnedSalary, netSalary
    };
}
