...
// 💵 ATTENDANCE PAGE MONEY SUMMARY UPDATE FUNCTION (EXACT UPDATED FORMULA)
function updateAttendanceMoneySummary(employeeId, month) {
    ...
    // 🎯 কত টাকা পাবো (সবসময় উপার্জিত স্যালারি)
    setText("attendanceNetDue", money(payroll.earnedSalary));
    
    // 🎯 কোম্পানি কত পাবে = বেসিক স্যালারি - মোট নেওয়া এডভান্স (যেমন ১৩,০০০ - ১৪,০০০ = -১,০০০ টাকা)
...
function calculateEmployeePayroll(employee, month) {
    ...
    // 🎯 কত টাকা পাবো = যতোদিন কাজ করেছে তার মোট অর্জিত বেতন (Earned Salary)
    const netSalary = Math.round(earnedSalary + bonus - deduction);

    // 🎯 কোম্পানি কত পাবে = বেসিক স্যালারি - মোট নেওয়া এডভান্স (যেমন ১৩,০০০ - ১৪,০০০ = -১,০০০ টাকা)
    const companyDue = Math.round(basicSalary + bonus - deduction - advanceTaken);
