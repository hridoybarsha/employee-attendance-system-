...
//  ATTENDANCE PAGE MONEY SUMMARY UPDATE FUNCTION (WITH COMPANY DUE)
function updateAttendanceMoneySummary(employeeId, month) {
    if (!employeeId) {
        ...
        animateValue("attendanceCompanyDue", 0, 0, 400, "Tk ");
        return;
    }
    ...
    animateValue("attendanceCompanyDue", 0, payroll.companyDue, 600, "Tk ");
}
...
/* ================= PAYROLL (ACCURATE PRESENT-BASED CALCULATION WITH EXTRA ADVANCE DUE) ================= */
function calculateEmployeePayroll(employee, month) {
    ...
    if (advanceTaken > totalCalculated) {
        netSalary = 0; //     
        companyDue = Math.round(advanceTaken - totalCalculated); //     
    } else {
        netSalary = Math.round(totalCalculated - advanceTaken); //    
        companyDue = 0;
    }
    ...
    return {
        ...
        bonus, advance: advanceTaken, deduction, earnedSalary, netSalary, companyDue
    };
}
