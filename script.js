...
function updateDashboard() {
    ...
    setText("nightShiftToday", todayRecords.filter(a => a.status === "Night Shift").length);
...
function calculateEmployeePayroll(employee, month) {
    ...
    const nightShift = records.filter(a => a.status === "Night Shift").length;
    ...
    // Night Shift is also counted as a Full Day for salary calculation
