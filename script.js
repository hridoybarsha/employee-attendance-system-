...
// 💵 ATTENDANCE PAGE MONEY SUMMARY UPDATE FUNCTION (CORRECTED CALCULATION)
function updateAttendanceMoneySummary(employeeId, month) {
    ...
    // ১. কত টাকা হলো (Earned Salary)
    setText("attendanceEarnedSalary", money(payroll.earnedSalary));
    
    // ২. কত টাকা নিয়েছি (Total Advance Taken)
    setText("attendanceAdvanceTaken", money(payroll.advance));
    
    // ৩. কত টাকা পাবো (অর্জিত টাকা থেকে নতুন এডভান্স বাদ দেওয়ার পর যা থাকে)
    setText("attendanceNetDue", money(payroll.netSalary));
    
    // ৪. কোম্পানি লোন বকেয়া (প্রাথমিক লোন + নতুন এডভান্স - অর্জিত স্যালারি)
...
/* ================= PAYROLL (ACCURATE CALCULATION: INITIAL LOAN + ADVANCE - EARNED SALARY) ================= */
function calculateEmployeePayroll(employee, month) {
    ...
    // 🎯 ১. কত টাকা পাবো = অর্জিত টাকা থেকে নতুন নেওয়া এডভান্স বাদ
    // যদি অর্জিত টাকা (যেমন ১৩,০০০) এর চেয়ে নতুন এডভান্স (যেমন ৫০০) কম হয়, তবে পাবে: ১৩,০০০ - ৫০০ = ১২,৫০০ টাকা
    const netSalary = Math.max(0, Math.round(totalCalculated - advanceTaken));

    // 🎯 ২. কোম্পানি লোন বকেয়া = প্রাথমিক লোন (১৩,০০০) + নতুন এডভান্স (৫০০) - অর্জিত স্যালারি (১৩,০০০) = ৫০০ টাকা
