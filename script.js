...
function calculateEmployeePayroll(employee, month) {
    ...
    const daysInMonth = new Date(Number(parts[0]), Number(parts[1]), 0).getDate(); // ২৮, ৩০ বা ৩১ দিন

    // ১ দিনের বেতন
    const perDaySalary = basicSalary / daysInMonth;

    // প্রকৃতপক্ষে যতোদিন কাজ করেছে বা এলাউড লিভ পেয়েছে তার অর্জিত বেতন
    ...
    // বোনাস, এডভান্স, ডিডাকশন অ্যাডজাস্টমেন্ট
    ...
    // চূড়ান্ত নেট স্যালারি = যতোদিন কাজ করেছে তার টাকা + বোনাস - এডভান্স - ডিডাকশন
...
function initSalarySlip() {
    ...
    button.addEventListener("click", () => {
        ...
        // স্লিপে অর্জিত বেতন (Earned Salary) দেখাবে যতোদিন কাজ করেছে ততোদিনের
