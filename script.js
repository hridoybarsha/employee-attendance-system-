...
function renderAttendanceCalendar() {
    ...
    let totalDuties = (summary["Full Day"] || 0) + 
                      (summary["Night Shift"] || 0) + 
                      ((summary["Full Day/Night Shift"] || 0) * 2) + 
                      ((summary["Night/Full Day Shift"] || 0) * 2) + 
                      ((summary["Half Day"] || 0) * 0.5) + 
                      (summary["Paid Leave"] || 0) +
                      (summary["Paid Weekly Off"] || 0);
...
/* ================= PAYROLL (FIXED FULL MONTH SALARY BASED ON 30 DAYS NORM) ================= */
function calculateEmployeePayroll(employee, month) {
    ...
    // মাস ৩১, ২৮ বা ৩০ দিনের যাই হোক না কেন, কোম্পানির নিয়ম অনুযায়ী পূর্ণ মাসের বেসিক স্যালারি পেতে হলে ৩০ দিনের স্ট্যান্ডার্ড ডিউটি ধরা হবে
    ...
    // কোম্পানি যদি ফিক্সড ৩০ দিনের বেসিক দিয়ে পুরো মাসের হিসাব করতে চায়, তবে কর্মী যদি পুরো মাস বা ম্যাক্সিমাম দিন উপস্থিত থাকে তবে পূর্ণ বেসিক স্যালারি নির্ধারিত হবে
    // এখানে ৩০ দিনের হিসেবে পার-ডে স্যালারি দিয়ে হিসাব করা হচ্ছে
    const earnedSalary = Math.round((basicSalary / standardDaysInMonth) * totalWorkingDays);
